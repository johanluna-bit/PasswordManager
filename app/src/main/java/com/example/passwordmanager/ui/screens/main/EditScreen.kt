...
@Composable
fun EditScreen (
    navController: NavController, viewModel: ItemsViewModel,
    id: Int,
    tittle: String?,
    email: String?,
    password: String?,
    ...
    Scaffold (
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "Editar Nota" , color = Color.White , fontWeight = FontWeight.Bold)
                } ,
        ...
        ContentEditScreen(it, navController, viewModel, id, tittle, email, password, typeAccount, description)
    }
}
