...
@Composable
fun Adjust(navController: NavHostController){
    Row (
...
@Composable
fun InfoOf(navController: NavHostController){
...
fun Logout(navController: NavHostController){
    ...
    Row (
        ...
        IconButton(
            ...
            Image(imageVector = Icons.Filled.ExitToApp, contentDescription ="OptionButton")
            Modifier
                .fillMaxWidth()
                .size(70.dp)
        }
